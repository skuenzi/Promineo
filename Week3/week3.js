...
console.log('Ages average:',getAverage())
...
console.log('Names average letters:',averageNumLetters())
...
console.log('Names concat string:',namesList())
...
console.log('First Element in array:',names[0])
...
console.log('Names lengths array:',namesLengths)
...
console.log('Total characters in [names]:',totalNamesLength)
...
console.log('Repeated words:',words('Hello', 3))
...
console.log('Full name:',fullName('Sara', 'Kuenzi'))
...
console.log('Is the total of array [20, 20, 20, 20] greater than 100?', greaterThan100([20, 20, 20, 20]))
console.log('Is the total of array [20, 20, 20, 50] greater than 100?',greaterThan100([20, 20, 20, 20, 50]))
...
console.log('Average of array [20, 20, 20, 20]:',arrAverage([20, 20, 20, 20]))
...
console.log('Is the average of array 1 [20, 20, 20, 40] greater than array 2 [20, 20, 20, 20]?',isGreater([20, 20, 20, 40], [20, 20, 20, 20]))
...
function willBuyDrink (isHotOutside, moneyInPocket) {
 ...
 console.log('Will buy drink? (false, 11)', willBuyDrink(false, 11))
 console.log('Will buy drink? (true, 9)', willBuyDrink(true, 9))
 console.log('Will buy drink? (false, 9)', willBuyDrink(false, 9))
